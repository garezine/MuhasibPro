...
using MuhasibPro.Infrastructure.Infrastructure.Extensions;
using MuhasibPro.Infrastructure.Infrastructure.Tools.DependencyExpressions;
...
namespace MuhasibPro.Infrastructure.Controls
{
    public sealed partial class DataGrid : UserControl, INotifyExpressionChanged
    {
        ...
        public ICommand ItemInvokedCommand
        {
            get
            {
                return (ICommand)GetValue(ItemInvokedCommandProperty);
            }
            set
            {
                SetValue(ItemInvokedCommandProperty, value);
            }
        }
