...
using MuhasibPro.Core.Infrastructure.Tools.DependencyExpressions;
...
namespace MuhasibPro.Core.Controls
{
    public sealed partial class DataList : UserControl, INotifyExpressionChanged
    {
        ...
        public ICommand ItemSecondaryActionInvokedCommand
        {
            get
            {
                return (ICommand)GetValue(ItemSecondaryActionInvokedCommandProperty);
            }
            set
            {
                SetValue(ItemSecondaryActionInvokedCommandProperty, value);
            }
        }
        ...
        public string DefaultCommands
        {
            get
            {
                return (string)GetValue(DefaultCommandsProperty);
            }
            set
            {
                SetValue(DefaultCommandsProperty, value);
            }
        }
        ...
        public bool IsMultipleSelection
        {
            get
            {
                return (bool)GetValue(IsMultipleSelectionProperty);
            }
            set
            {
                SetValue(IsMultipleSelectionProperty, value);
            }
        }
        ...
        public ICommand QuerySubmittedCommand
        {
            get
            {
                return (ICommand)GetValue(QuerySubmittedCommandProperty);
            }
            set
            {
                SetValue(QuerySubmittedCommandProperty, value);
            }
        }
        ...
        public ICommand StartSelectionCommand
        {
            get
            {
                return (ICommand)GetValue(StartSelectionCommandProperty);
            }
            set
            {
                SetValue(StartSelectionCommandProperty, value);
            }
        }
        ...
        public ICommand CancelSelectionCommand
        {
            get
            {
                return (ICommand)GetValue(CancelSelectionCommandProperty);
            }
            set
            {
                SetValue(CancelSelectionCommandProperty, value);
            }
        }
        ...
        public ICommand SelectItemsCommand
        {
            get
            {
                return (ICommand)GetValue(SelectItemsCommandProperty);
            }
            set
            {
                SetValue(SelectItemsCommandProperty, value);
            }
        }
        ...
        public ICommand DeselectItemsCommand
        {
            get
            {
                return (ICommand)GetValue(DeselectItemsCommandProperty);
            }
            set
            {
                SetValue(DeselectItemsCommandProperty, value);
            }
        }
        ...
        public ICommand SelectRangesCommand
        {
            get
            {
                return (ICommand)GetValue(SelectRangesCommandProperty);
            }
            set
            {
                SetValue(SelectRangesCommandProperty, value);
            }
        }
        ...
        public string DataUnavailableMessage => ItemsSource == null ? "Yükleniyor..." : "Öðe bulunamadý.";
