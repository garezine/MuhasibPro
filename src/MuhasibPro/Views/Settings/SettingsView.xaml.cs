...
{
    // Çalýþma dönemi deðiþtirme logic'i burada
    // Mevcut ChangeCompanyButton_Click method'unuza benzer þekilde implement edin
}
        ...
        private async void ChangeCompanyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Title = "Firma Deðiþtir",
                Content = "Firma deðiþtirme özelliði yakýnda eklenecek.",
        ...
        private async void ViewReleaseNotes_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                await ShowErrorDialog($"Sürüm notlarý açýlamadý: {ex.Message}");
            }
        }
        ...
        private async void ViewLicense_Click(object sender, RoutedEventArgs e)
        {
            var dialog = new ContentDialog
            {
                ...
                Content = "MuhasibPro\n© 2025 Tüm haklarý saklýdýr.\n\nBu yazýlým ticari kullaným için lisanslanmýþtýr.",
                CloseButtonText = "Tamam",
                XamlRoot = this.XamlRoot
            };
