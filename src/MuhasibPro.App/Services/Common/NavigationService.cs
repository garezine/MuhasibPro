...
namespace MuhasibPro.App.Services.Common;
...
public partial class NavigationService : INavigationService
{
    ...
    {
        return await WindowManagerHelper.CreateWindowAsync<TViewModel>(parameter, customTitle);
    }
    ...
    public async Task<Window> CreateNewViewAsync(Type viewModelType, object parameter = null, string customTitle = null)
    {
        ...
        var method = typeof(WindowManagerHelper).GetMethod("CreateWindowAsync")
    ...
    public async Task CloseViewAsync()
    {
        ...
        if (currentWindow != null && currentWindow != MainWindow)
        {
            ...
            if (windowId != null)
            {
                await WindowManagerHelper.CloseWindowAsync(windowId);
            }
        }
    }
