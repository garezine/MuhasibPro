...
{
    /// <inheritdoc />
    public partial class SplitAppVersiyonToBaseAndSistemDbVersiyon : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SonSecilenKullaniciFirmaDonemler",
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SonSecilenKullaniciFirmaDonemler", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UygulamaVersiyon = table.Column<string>(type: "TEXT", nullable: false),
                    SistemDBVersiyon = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false),
                    FirmaId = table.Column<long>(type: "INTEGER", nullable: false),
                    MaliDonemYil = table.Column<int>(type: "INTEGER", nullable: false),
                    KaydedenId = table.Column<long>(type: "INTEGER", nullable: false),
                    KayitTarihi = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    GuncellemeTarihi = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    GuncelleyenId = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "UygulamaVersiyon", "OncekiSistemDbVersiyon", "SistemDBSonGuncellemeTarihi", "SistemDBVersiyon" },
                values: new object[] { "1.0.0", null, new DateTime(2025, 9, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "1.0.0" });
